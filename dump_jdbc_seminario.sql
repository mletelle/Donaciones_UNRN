...
CREATE TABLE `ordenes_entrega` (
  ...
  KEY `fk_oe_pedido` (`id_pedido_origen`),
...
INSERT INTO `ordenes_entrega` VALUES (1,'2025-12-16 11:21:00',NULL,NULL,1,'ldifabio','ihoncharuk',NULL,NULL);
...
INSERT INTO `usuarios` VALUES ('admin',1,'1234','Admin','Sistema','admin@unrn.edu.ar',1,'11111111',NULL,NULL,0,NULL,NULL),('bgoro',2,'pass','Bruno','Goro','bgoro@unrn.edu.ar',1,'22222222',NULL,NULL,0,NULL,NULL),('ihoncharuk',4,'1234','Ian','Honcharuk','ianh@email.com',1,'44455566','Av. Siempre Viva 742','Alimentos no perecederos y leche',4,'ALTA',NULL),('ldifabio',2,'pass','Lucas','Difabio','ldifabio@unrn.edu.ar',1,'44444444',NULL,NULL,0,NULL,NULL),('lperise',3,'pass','Lautaro','Perise','lperise@unrn.edu.ar',1,'66666666','Avenida Siempre Viva 742',NULL,0,NULL,NULL),('mcamba',2,'pass','Mauro','Camba','mcamba@unrn.edu.ar',0,'33333333',NULL,NULL,0,NULL,NULL),('nbravo',4,'1234','Naim','Bravo','nbravo@email.com',1,'11122233','Calle Falsa 123','Ropa de invierno y calzado talle 40',2,'MEDIA',NULL),('rargel',3,'pass','Ramiro','Argel','rargel@unrn.edu.ar',1,'55555555','Calle Falsa 123',NULL,0,NULL,NULL);
...
INSERT INTO `visitas` VALUES (19,12,13,'2025-11-16 20:46:56','Recoleccion Exitosa','Retiro exitoso ',NULL),(20,13,20,'2025-11-18 19:13:14','Recoleccion Exitosa','Retiro exitoso ',NULL);
